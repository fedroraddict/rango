---
description: Analyzes RFID card dump files offline — Mifare Classic/Ultralight dumps (sector trailers, access-bits decode, value blocks, ASCII content) and LF sniff captures. Use when a card dump or LF sniff capture file needs offline analysis.
mode: subagent
permission:
  edit: deny
  bash: allow
